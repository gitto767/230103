...
<body>
  ...
  <div class="container">
    ...
    <p>주문은 <%out.println(shipping_shippingDate);%>에 배송될 예정 입니다.!!!!</p>
...
<% 
    ...
    for(int i=0;i<cookies.length;i++){
    	...
    	if(n.equals("Shippin_cartId"))
    		thisCookie.setMaxAge(0);
    	if(n.equals("Shippin_name"))
    		thisCookie.setMaxAge(0);
    	if(n.equals("Shippin_shippingDate"))
    		thisCookie.setMaxAge(0);
    	if(n.equals("Shippin_country"))
    		thisCookie.setMaxAge(0);
    	if(n.equals("Shippin_zipCode"))
    		thisCookie.setMaxAge(0);
    	if(n.equals("Shippin_addressName"))
    		thisCookie.setMaxAge(0);
